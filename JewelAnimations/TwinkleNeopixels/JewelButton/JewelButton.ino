...
Use a button to flip through various color palettes in a twinkle effect. 
Settings (in order): OFF > GREEN_BLUE > RED_PURPLE_BLUE > YELLOW_ORANGE_RED > (back to OFF)

Meant for a single Neopixel Jewel, but can be adapted to other form factors/numbers of NeoPixels.
...
void updateButtonState() {
  ...
  } else {    // Button state did not change since last loop
